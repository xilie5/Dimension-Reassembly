...
| ID | 任务 | 状态 | 验收 |
| --- | --- | --- | --- |
| S7-1 | 自动关卡指标 | DONE | 尺寸、实体、目标、解法、推动、主机制 |
| S7-2 | 章节选择界面 | DONE | `L` 打开，锁关不可进入 |
| S7-3 | 难度曲线复核 | DOING | 逐关检查解法长度和主要转折 |
| S7-4 | 最终截图与演示材料 | NEXT | 三张区域截图和演示视频 |
| S7-5 | 1.0 发布检查 | NEXT | 存档、构建、文档和全通关 |
